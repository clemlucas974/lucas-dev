        ...
        >
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400 max-w-3xl mx-auto">
              I'm a passionate Senior Fullstack Engineer with over a decade of experience
              building scalable applications and leading technical teams. I specialize in
              modern JavaScript frameworks, cloud infrastructure, and creating exceptional
              digital experiences.
            </p>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="glass-card p-8 md:p-10 relative">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-300 mb-4 leading-relaxed">
                I've collaborated with innovative startups and established companies to build robust,
                scalable applications that solve real-world problems. My approach combines technical
                excellence with a deep understanding of business needs and user experience.
              </p>
              <p className="text-gray-300 leading-relaxed">
                Throughout my career, I've led technical teams, mentored junior developers,
                and architected systems that can withstand the test of time and scale. I'm
                particularly passionate about clean code, performance optimization, and embracing
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="border border-slate-800 bg-slate-900/50 rounded-lg p-4">
                  ...
                  <p className="text-gray-400">
                    Create beautiful, responsive, and performant user interfaces using
                ...
                <div className="border border-slate-800 bg-slate-900/50 rounded-lg p-4">
                  ...
                  <p className="text-gray-400">
                    Lead development teams, mentor junior engineers, and ensure
