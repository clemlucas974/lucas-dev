...
const projects = [
  {
    id: 1,
    title: 'SEKAI',
    description: 'Next-level entertainment for Anime fans between episodes, built in partnership with major Japanese licensors.',
    details: 'SEKAI is built in partnerships with major Japanese Anime licensors and backed by world-class investors and public figures including Alexis Ohanian (reddit) and Mike Shinoda (Linkin Park), Xavier Niel (New Wave) and Alexandre Yazdi (Voodoo Games). The company has offices in Paris and Tokyo.',
  ...
  },
  {
    id: 2,
    title: 'BAM KARAOKE',
    description: 'As Lead Tech, I developed BAM Karaoke Box\'s new tech system, focusing on Admin, Booking websites and AWS infrastructure.',
  ...
  },
  {
    id: 3,
    title: 'POPCHEF',
    description: 'Paired with product teams to translate requirements into technical specifications and led DevOps transformation.',
    details: 'Created DevOps team to migrate AWS infrastructure to Terraform/k8s/helm and automate CI/CD pipelines for the entire stack. Reduced technical debt while developing new scalable products. Reworked the desktop web app, created a cash register React-Native Android app prototype, and stabilized the delivery man mobile app.',
        ...
        >
          {projects.map((project) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-display font-semibold mb-2 text-white">{project.title}</h3>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
            ...
            >
              ...
              <div className="p-6 md:p-8">
                <h3 className="text-2xl font-display font-bold mb-4 text-white">{activeProject.title}</h3>
                <p className="text-gray-300 mb-6">{activeProject.details}</p>
                <div className="mb-6">
                  <h4 className="text-sm uppercase text-gray-500 mb-3 tracking-wider font-medium">Technologies</h4>
