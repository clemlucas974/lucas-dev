      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="md:col-span-2">
            <a href="#" className="text-2xl font-bold text-gradient font-display mb-4 inline-block">
              &lt;Developer/&gt;
            </a>
            <p className="text-gray-400 mb-6 max-w-md">
              Senior Fullstack Engineer specializing in modern web technologies and cloud infrastructure.
              Building exceptional digital experiences for innovative companies.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <svg className="h-5 w-5 text-indigo-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="ml-3 text-gray-400">contact@developer.com</span>
              </li>
              <li className="flex items-start">
                <svg className="h-5 w-5 text-indigo-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="ml-3 text-gray-400">Paris, France</span>
              </li>
            </ul>
          </div>
        </div>

        <div className="pt-8 mt-8 border-t border-slate-800/50 text-center md:flex md:items-center md:justify-between">
