            ...
            <div className="glass-card p-6 md:p-8">
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <div key={index} className="flex items-start">
                    <div className="mt-1 bg-slate-800 rounded-lg p-3">
                      {info.icon}
                    </div>
                    <div className="ml-4">
                      <h4 className="text-sm font-medium text-gray-400">{info.title}</h4>
                      {info.link ? (
                        <a href={info.link} className="text-base text-white hover:text-indigo-400 transition-colors">
                          {info.content}
                        </a>
                      ) : (
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-slate-800 p-3 rounded-lg text-gray-300 hover:text-white hover:bg-indigo-600 transition-colors">
